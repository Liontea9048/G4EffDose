...
//		phantomDataPath = "../phantoms";
	...
	// set phantom name
	if(!isAF) phantomName = "MRCP_AM"; //If the Phantom name is not a AF -> Set the PhantomName as MRCP_AM
	else      phantomName = "MRCP_AF"; //If the Phantom name is a AF -> Set the PhantomName as MRCP_AF
	...
	G4String nodeFile     =  phantomName + ".node"; // node file
