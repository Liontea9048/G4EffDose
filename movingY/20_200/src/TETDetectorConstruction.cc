...
void TETDetectorConstruction::SetupWorldGeometry()
{
	...
	new G4PVPlacement(0,
					  G4ThreeVector(PhantomBoxX, PhantomBoxY + 200.*cm, PhantomBoxZ), container_logic, "PhantomPhysical", worldLogical, false, 0, checkOverlaps);
