...
#ifndef TETPSCellFlux_h
#define TETPSCellFlux_h 1
...
class TETPSCellFlux : public G4PSCellFlux
{
   public:
      TETPSCellFlux(G4String name,TETModelImport* _tetData);
      virtual ~TETPSCellFlux();
