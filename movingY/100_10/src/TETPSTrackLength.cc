...
//
// TETPSTrackLength.cc
// \file   MRCP_GEANT4/External/src/TETPSTrackLength.cc
// \author Haegin Han
//
...
TETPSTrackLength::TETPSTrackLength(G4String name, TETModelImport* _tetData)
  :G4PSTrackLength(name), tetData(_tetData)
{}
