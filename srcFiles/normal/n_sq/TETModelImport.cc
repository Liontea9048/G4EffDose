...
//		phantomDataPath = "../phantoms";
	...
	// set phantom name
	if(!isAF) phantomName = "AM-squatting"; //If the Phantom name is not a AF -> Set the PhantomName as MRCP_AM
	else      phantomName = "AM-squatting"; //If the Phantom name is a AF -> Set the PhantomName as MRCP_AF
