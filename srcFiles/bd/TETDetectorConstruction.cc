...
void TETDetectorConstruction::SetupWorldGeometry()
{
	...
	//	G4Material* Soil_formation = new G4Material("Soil_formation", 2.255*g/cm3, 11);
	//	Soil_formation->AddMaterial(Silicon,0.3579); // 0.3556 + 0.0027 = 0.
	//	Soil_formation->AddMaterial(Aluminium,0.0675);
	//	Soil_formation->AddMaterial(Feric,0.0084);
	//	Soil_formation->AddMaterial(Magnesium, 0.0006);
	//	Soil_formation->AddMaterial(Calcium,0.0051);
	//	Soil_formation->AddMaterial(Sodium,0.0271);
	//	Soil_formation->AddMaterial(Potassium,0.0401);
	//	Soil_formation->AddMaterial(Manganese,0.0004);
	//	Soil_formation->AddMaterial(Phosphorus,0.0002);
	//	Soil_formation->AddMaterial(Titanium, 0.0006);
	//	Soil_formation->AddMaterial(Oxygen, 0.4921); // 0.9
