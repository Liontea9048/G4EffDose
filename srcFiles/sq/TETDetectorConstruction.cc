...
void TETDetectorConstruction::SetupWorldGeometry()
{
	...
	G4double PhantomBoxY = 48.7 * cm + (2.54 * 4) * cm + 10.0 * cm; // at the edge of borehole + 1 m far from the hole
	G4double PhantomBoxZ = 66.2 * cm + (height_of_soil + centerofSoil); // 2.5 m
