...
private:
	...
	// G4SDParticleWithEnergyFilter* gamma_e;
	// G4SDParticleWithEnergyFilter* n_10keV;
	// G4SDParticleWithEnergyFilter* n_100keV;
	// G4SDParticleWithEnergyFilter* n_2MeV;
	// G4SDParticleWithEnergyFilter* n_20MeV;
	// G4SDParticleWithEnergyFilter* p_lower;
	// G4SDParticleWithEnergyFilter* p_upper;
	// G4SDParticleWithEnergyFilter* alphafilter;

	// 2021 01 11.
	G4SDParticleWithEnergyFilter* n_1;
	G4SDParticleWithEnergyFilter* n_50;
	G4SDParticleWithEnergyFilter* gem;
	G4SDParticleWithEnergyFilter* hp;
	G4SDParticleWithEnergyFilter* alpha;
	G4double upper_Housing_length;
	G4double lower_Housing_length;
	G4double upper_Sonde_length;
	G4double lower_Sonde_length;
	G4double placement_of_Sonde;
	G4double placement_of_upper_Housing;
	G4double placement_of_lower_Housing;
